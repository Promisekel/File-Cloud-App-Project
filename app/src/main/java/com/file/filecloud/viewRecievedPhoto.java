...
public class viewRecievedPhoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    DownloadManager downloadManager = (DownloadManager) getApplicationContext().getSystemService(viewRecievedPhoto.this.DOWNLOAD_SERVICE);
                    ...
                    Toast toast = Toast.makeText(viewRecievedPhoto.this,"Downloading to Documents/File Cloud/",Toast.LENGTH_LONG);
        ...
        deleteTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(viewRecievedPhoto.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    final ProgressDialog progress = new ProgressDialog(viewRecievedPhoto.this);
                                                ...
                                                ref.child(user.getUid()).child("Trash").child(Timestamp)
                                                        ...
                                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                            ...
                                                            public void onSuccess(Void aVoid) {
                                                                progress.dismiss();
                                                                Toast.makeText(viewRecievedPhoto.this, "Moved Successfully...", Toast.LENGTH_LONG).show();
                                                                viewRecievedPhoto.this.finish();
                                                            }
                                                        }).addOnFailureListener(new OnFailureListener() {
                                                    @Override
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(viewRecievedPhoto.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                                    }
                                                });
        ...
        shareTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(viewRecievedPhoto.this, shareListActivity.class);
