...
public class PPT_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pptRv = view.findViewById(R.id.pptRv);
        ...
        reference.child(uid).child("Files")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        pptRv.setAdapter(fileTapAdapter);
    ...
    private void searchPPTs(final String query) {
        filesModels = new ArrayList<>();
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
        reference.child(uid).child("Files")
                .addValueEventListener(new ValueEventListener() {
